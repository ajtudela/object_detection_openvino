...
ObjectDetectionOpenvino::ObjectDetectionOpenvino(ros::NodeHandle& node, ros::NodeHandle& node_private): node_(node), nodePrivate_(node_private), imageTransport_(nodePrivate_){
	...
	detection2DPub_ = nodePrivate_.advertise<object_detection_openvino::Detection2DArray>(detection2DTopic_, 1);
...
bool ObjectDetectionOpenvino::updateParams(std_srvs::Empty::Request &req, std_srvs::Empty::Response &res){
	...
	nodePrivate_.param("detection_image_topic", detectionImageTopic_, std::string("detected_image"));
	nodePrivate_.param("detection_2d_topic", detection2DTopic_, std::string("detection2d"));
